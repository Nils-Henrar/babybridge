...
Route::middleware(['auth', 'can:worker'])->group(function () {
    ...
    Route::get('worker/worker/create', [WorkerController::class, 'create'])->name('worker.worker.create');
    Route::post('worker/worker', [WorkerController::class, 'store'])->name('worker.worker.store');
